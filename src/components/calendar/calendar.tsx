...
export class Calendar {
  ...
  private _getRangedDays(startDay: Day, endDay: Day): Array<Day> {
    ...
    if (startDay == endDay) {
      ...
      for (let date = new Date(startDate); date <= endDate; date.setDate(date.getDate() + 1)) {
        ...
        day.dateString = this._formatPicked(day);
  ...
  private _selectDay(day: Day): void {
    if (this.selectedDay === day && this.allowUnselectDate) {
      ...
      this.selectedDay.dateString = this._formatPicked(this.selectedDay);
  ...
  private _selectMultiple(date: Day): void {
    ...
    if (this.selectedDays.length === 0) {
      ...
      date.dateString = this._formatPicked(date);
    ...
    if (this.selectedDay) {
      toolbarEventButtons = (
        <div class="bc-toolbar-end">
          <button class="bc-toolbar-action-button bc-add-event-button bc-button-success"
        ...
        <div>
          ...
          {this.selectedDay && this.selectedDay.hasEvent ?
            <div class="bc-calendar-toolbar-second">
              <button class="bc-toolbar-action-button bc-modify-events-button bc-button-success"
                onClick={() => this._onReplaceEvent()}>
                Replace event
                            </button>
              <button class="bc-toolbar-action-button bc-modify-events-button bc-button-danger"
      ...
      <div class="bc-calendar-container">
            ...
            >
              ...
              >
                ...
                <span class={date.hasEvent ? 'bc-day-event-dot' : ''}
                  style={date.hasEvent ? date.data[0].style : ''} />
              </span>
            </div>
          ))}
        </div>
        ...
        {this.showRangeSelect ?
          <div class="bc-range-select">
            <select class="bc-selection-select"
              onChange={(event: UIEvent) => this._changeSelection(event.target['value'])}>
