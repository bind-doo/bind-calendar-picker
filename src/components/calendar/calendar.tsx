...
export class Calendar {
    ...
    render() {
        ...
        if (this.selectedDay) {
            toolbarEventButtons = (
                <div class="bc-toolbar-end">
                    <button
                        class="bc-toolbar-action-button bc-button-success"
              ...
              <button
                  class="bc-toolbar-action-button bc-button-danger"
        ...
        if (this.showToolbar) {
            toolbarTemplate = (
                <div>
                    <div class="bc-calendar-toolbar-top">
                        <div class="bc-toolbar-start">
                            <button class="bc-toolbar-button" onClick={() => this.selectToday()}>
                                Today
                            </button>
                        </div>
                        {toolbarEventButtons}
